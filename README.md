...
- [x] 테스트는 **살아있는 문서**다: 프로덕션 코드의 요구사항과 히스토리를 담는다
- [x] **`@DisplayName`을 섬세하게** — "~테스트"가 아니라, 도메인 용어로 **행위와 결과**를 문장으로 서술하기
- [x] **BDD 스타일** 작성법 — `Given` / `When` / `Then` 으로 시나리오 드러내기
- [x] 팀의 지식이 코드에 남아 다음 사람에게 전달되는 구조 만들기
